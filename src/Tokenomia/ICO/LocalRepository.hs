                ...
                Round
                  ...
                  , settings =
                      RoundSettings
                        ...
                        , kycIntegration =
                            Integration
                              { params = \(ChildAddressIndex index) -> "admin=xR0CE2Vk80fOoD57slc4&from_user=" <> show index <> "&round=1"
                ...
                Round
                  ...
                  , settings =
                      RoundSettings
                        ...
                        , kycIntegration =
                            Integration
                              { params = \(ChildAddressIndex index) -> "admin=xR0CE2Vk80fOoD57slc4&from_user=" <> show index <> "&round=2"
                              , url = "https://api.cardashift.com/api/admin/participants"
                              }
